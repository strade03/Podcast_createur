...
public:
    ...
    void mixWithBackground(const QString &voiceFile, const QString &musicFile, float volumeMusic, float offsetSeconds, bool enableDucking, const QString &outputFile);
